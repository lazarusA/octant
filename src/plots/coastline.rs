...
impl CoastlineRenderer {
    ...
    pub fn new(
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("shaders/coastline.wgsl").into(),
            ),
        });
        ...
        let safe_verts: &[f32] = if verts.is_empty() { &[0.0_f32, 0.0] } else { verts };
        ...
        Self {
            ...
            bind_group_layout,
            uniform_buffer,
            gpu: RwLock::new(CoastlineGpuResources { vertex_buffer, bind_group }),
    ...
    pub fn swap_vertices(
        ...
        self.vertex_count.store((verts.len() / 2) as u32, Ordering::Relaxed);
    }
}
...
impl eframe::egui_wgpu::CallbackTrait for CoastlineCallback {
    ...
    fn paint(
        ...
        let Ok(guard) = self.renderer.gpu.read() else { return };
